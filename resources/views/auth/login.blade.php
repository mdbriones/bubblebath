@extends('layouts.app', [
    ...
    'activePage' => 'login',
    'backgroundImage' => asset('assets') . "/img/bg1.jpg",
])
    ...
    <div class="content">
        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <div class="logo-container" style="width: 300px; height: 100px;">
                    <img style="max-width: 300px;" src="{{ asset('assets/img/bubblebath-logo.png') }}" alt="">
                </div>
                </div>
                <div class="card-body ">
                ...
                <div class="card-footer ">
                    ...
                    <div align="center">
                        <h6>
                            <a href="#" class="link footer-link">Bubblebath 2019</a>
