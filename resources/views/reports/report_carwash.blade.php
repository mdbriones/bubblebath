@extends('layouts.app', [
    'namePage' => 'carwash report',
    'class' => 'sidebar-mini',
    'activePage' => 'reportsCarwash',
    // 'activeNav' => '',
])
            ...
            <table width="100%" style="margin-bottom: -20px;">
                <tr>
                  ...
                  <td style="width: 300px;">
                      <form method="get" action="{{ route('carwash.report') }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <table width="100%">
                            <tr>
                                <td>
                ...
                @if (isset($records))
                  @foreach( $records as $record )
                    <tr>
                      ...
                      @endphp
                      <td>{{ $services }}</td>
                      <td>{{ number_format($record->totalAmount, 2) }}</td>
                    </tr>
                  @endforeach
                @endif
              </tbody>
