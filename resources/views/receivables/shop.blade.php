            ...
            <table id="tblReceivables" class="table table-striped display responsive nowrap table-bordered data-table-export" style="width:100%">
              ...
              <tbody>
                @foreach ($data as $item)
                    <tr data_id="{{ $item->id }}">
                      <td><label style="color:#292929;">{{ $item->name_ }}</label></td>
                      <td><label style="color:#292929;">{{ $item->date_ }}</label></td>
                      <td><label style="color:#292929;">{{ $item->plateNumber_ }}</label></td>
                      <td><label style="color:#292929;">{{ $item->service_description_ }}</label></td>
                      <td><label style="color:#292929;">{{ $item->make_model_ }}</label></td>
                      <td><label style="color:#292929;">{{ number_format($item->service_amount_, 2) }}</label></td>
